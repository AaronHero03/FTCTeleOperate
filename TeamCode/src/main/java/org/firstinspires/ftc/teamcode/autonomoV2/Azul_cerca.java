...
@Autonomous
public class Azul_cerca extends LinearOpMode{
    int rightF = 0;
    int rightB= 0;
    int leftF= 0;
    int leftB= 0;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            ...
            RightF.setTargetPosition(rightF + cv.INCH_TO_TICKS(26));
            RightB.setTargetPosition(rightB + cv.INCH_TO_TICKS(26));
            LeftF.setTargetPosition(leftF + cv.INCH_TO_TICKS(26));
            LeftB.setTargetPosition(leftB + cv.INCH_TO_TICKS(26));
            waitForArrive();
            encoderUpdate();
            ...
            //Left and right
                ...
                waitForArrive();
                encoderUpdate();
                while (orientation.getYaw(AngleUnit.DEGREES) > 88 || orientation.getYaw(AngleUnit.DEGREES) < 86) {
