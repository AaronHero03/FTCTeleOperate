...
@Autonomous
public class Azul extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if(count == 1){
                ...
                RightF.setTargetPosition(conversion.INCH_TO_TICKS(5));
                RightB.setTargetPosition(conversion.INCH_TO_TICKS(5));
                LeftF.setTargetPosition(conversion.INCH_TO_TICKS(5));
                LeftB.setTargetPosition(conversion.INCH_TO_TICKS(5));
