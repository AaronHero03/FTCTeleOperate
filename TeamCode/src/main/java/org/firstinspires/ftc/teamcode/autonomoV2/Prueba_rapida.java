...
@Autonomous
public class Prueba_rapida extends LinearOpMode{
    int rightF = 0;
    int rightB= 0;
    int leftF= 0;
    int leftB= 0;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            ...
            RightF.setTargetPosition(rightF - 400);
            RightB.setTargetPosition(rightB + 3000);
            LeftF.setTargetPosition(leftF + 3000);
            LeftB.setTargetPosition(leftB - 400);
            waitForArrive();
            encoderUpdate();
